...
CHUNK_SIZE = 3000  # rows per upload chunk
CTR_THRESHOLD = 0.01  # 1% minimum CTR to keep


def send_to_google_sheets(rows, is_first_chunk=True):
    """Send a list of row dicts to Google Sheets via the Apps Script web app."""
    payload = {
        "action": "import_data",
...
def main():
    print("=" * 70)
    print("Google Search Console -> Google Sheets (blog.aspose.com)")
    print("=" * 70)
    ...
    output_filename = os.path.join(csv_folder, "aspose.csv")
