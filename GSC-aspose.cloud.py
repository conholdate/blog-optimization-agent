...
def main():
    print("=" * 70)
    print("Google Search Console -> Google Sheets (blog.aspose.cloud)")
    print("=" * 70)
    ...
    # 2) Property
    property_url = "https://blog.aspose.cloud/"
    ...
    df = df[df["page"].str.contains("blog.aspose.cloud", na=False)]
    ...
    output_filename = os.path.join(csv_folder, "aspose-cloud.csv")
