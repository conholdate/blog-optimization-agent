...
def main():
    print("=" * 70)
    print("Google Search Console -> Google Sheets (blog.groupdocs.cloud)")
    print("=" * 70)
    ...
    # 2) Property
    property_url = "https://blog.groupdocs.cloud/"
    ...
    df = df[df["page"].str.contains("blog.groupdocs.cloud", na=False)]
    ...
    output_filename = os.path.join(csv_folder, "groupdocs-cloud.csv")
